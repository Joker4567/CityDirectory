...
val MIGRATION_2_3 = object : Migration(1, 2) {
    override fun migrate(database: SupportSQLiteDatabase) {
        ...
        database.execSQL("CREATE TABLE IF NOT EXISTS `${FellowContract.tableName}` (`id` INTEGER NOT NULL, `city` TEXT NOT NULL, `description` TEXT NOT NULL, `date` TEXT NOT NULL, PRIMARY KEY(`id`))")
    }
}